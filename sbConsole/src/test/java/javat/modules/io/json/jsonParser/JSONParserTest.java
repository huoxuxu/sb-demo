package javat.modules.io.json.jsonParser;

import com.hxx.sbcommon.common.io.http.ApacheHttpClientSimpleUseful;
import com.hxx.sbcommon.common.io.json.jsonparser.JSONParser;
import com.hxx.sbcommon.common.io.json.jsonparser.JsonArray;
import com.hxx.sbcommon.common.io.json.jsonparser.JsonObject;
...
//       String json = getJSON();
    ...
    private String getJSON() throws IOException {
        ...
        bodyMap.put("params", "kJMudgZJvK8p8STuuxRpkUvO71Enw4C9y91PBkVTv2SMVnWG30eDKK1iAPcXnEah");
        bodyMap.put("encSecKey", "");
        StringBuilder sb = new StringBuilder();
        bodyMap.forEach((k, v) -> sb.append(k + "=" + v));
        String body = sb.toString();
        // send
        return ApacheHttpClientSimpleUseful.sendPostUrlEncoded(url, null, body);
    }
}
