 ...
 **/
@Slf4j
public class POIExcelReadUseful implements Closeable {
    ...
    public POIExcelReadUseful(String fileName, InputStream inputStream) throws Exception {
            ...
            switch (cell.getCellType()) {
                ...
                case NUMERIC: {
                    ...
                    if (cell instanceof XSSFCell) {
                        ...
                        cellv = String.valueOf(cell.getNumericCellValue());
                    }
