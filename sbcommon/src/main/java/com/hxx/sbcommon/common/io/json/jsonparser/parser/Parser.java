package com.hxx.sbcommon.common.io.json.jsonparser.parser;
...
import com.hxx.sbcommon.common.io.json.jsonparser.tokenizer.Token;
import com.hxx.sbcommon.common.io.json.jsonparser.tokenizer.TokenList;
import com.hxx.sbcommon.common.io.json.jsonparser.tokenizer.TokenType;
...
public class Parser {
    ...
    private JsonArray parseJsonArray() {
        int expectToken = BEGIN_ARRAY_TOKEN | END_ARRAY_TOKEN
                | BEGIN_OBJECT_TOKEN
                | NULL_TOKEN
        ...
        while (tokens.hasMore()) {
            ...
            switch (tokenType) {
                ...
                case SEP_COMMA:
                    checkExpectToken(tokenType, expectToken);
                    expectToken = BEGIN_ARRAY_TOKEN
                            | BEGIN_OBJECT_TOKEN
                            | NULL_TOKEN
                            | STRING_TOKEN | NUMBER_TOKEN | BOOLEAN_TOKEN;
                    break;
                case END_DOCUMENT:
                    checkExpectToken(tokenType, expectToken);
                    return jsonArray;
